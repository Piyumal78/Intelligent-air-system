...
const AdminDevices = () => {
  ...
  const [newDevice, setNewDevice] = useState({ id: "", location: "", assignedUser: null })
  ...
  const handleRegister = async (e) => {
    ...
    setNewDevice({ id: "", location: "", assignedUser: null })
        ...
        {devices.map((device) => (
          ...
          >
            ...
            <p className="text-slate-500 text-sm mb-4">
              Location: <span className="font-medium text-slate-700">{device.location}</span>
            </p>
